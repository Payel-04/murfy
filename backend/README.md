...
Sign up for [LiveKit Cloud](# list installed Python launchers
py -0p
# install venv with Python 3.11 (if available)
py -3.11 -m venv .venv) then set up the environment by copying `.env.example` to `.env.local` and filling in the required keys:
